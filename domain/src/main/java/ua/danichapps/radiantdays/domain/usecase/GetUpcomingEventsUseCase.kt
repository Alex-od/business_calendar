...
/**
 * Fetches notes whose alarms fall within a given time window.
 *
 * Used by:
...
class GetUpcomingEventsUseCase(private val repository: CalendarEventRepository) {
    ...
    /**
     * @param fromMillis Start of the alarm window (inclusive) in epoch milliseconds.
     * @param toMillis   End of the alarm window (exclusive) in epoch milliseconds.
     */
